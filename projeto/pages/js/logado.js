...
registrarMetas.addEventListener('click', (event) => {
    ...
    if (inputMeta) {
        ...
        fetch('https://life-balance-server-of8ff1f6z.vercel.app/api/metas', {
            method: 'POST',
            headers: {
...
function concluirMeta(metaId, event) {
    ...
    fetch(`https://life-balance-server-of8ff1f6z.vercel.app/api/metas/${metaId}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
...
registrarImc.addEventListener('click', (event) => {
    ...
    fetch('https://life-balance-server-of8ff1f6z.vercel.app/api/caracteristica', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`, 
...
document.getElementById('registrarAtividade').addEventListener('click', (event) => {
    ...
    fetch('https://life-balance-server-of8ff1f6z.vercel.app/api/atividades', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
...
function atualizarContagemMensal() {
    fetch('https://life-balance-server-of8ff1f6z.vercel.app/api/atividades-mensais', {
        headers: {
            'Authorization': `Bearer ${token}`,
        },
    })
